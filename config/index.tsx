...
import { mainnet, arbitrum, base, polygon, bsc, avalanche } from '@reown/appkit/networks'
...
export const networks: [Chain, ...Chain[]] = [mainnet, arbitrum, base, polygon, bsc, avalanche]
